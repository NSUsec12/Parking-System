...
public class CarParking {
	...
	private void initialize() {
		...
		CPbtnHome.setIcon(new ImageIcon("D:\\car-parking-management-system-java-master\\NSU Car Parking Management System\\picture\\New folder\\home.png"));
		...
		JButton CPbtnParkRe = new JButton("PARKING MAP");
		CPbtnParkRe.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ParkingRef pr= new ParkingRef();  //calling parking map. window will come.
				ParkingRef.main(null);
				frmCarParking.setVisible(false);
			}
		});
		CPbtnParkRe.setFont(new Font("Sitka Text", Font.BOLD, 11));
		CPbtnParkRe.setBounds(386, 69, 150, 42);
		...
		CPbtnAbout.setBounds(534, 69, 142, 42);
		...
		CPbtnLogout.setBounds(674, 69, 46, 42);
		...
		label_1.setIcon(new ImageIcon("D:\\car-parking-management-system-java-master\\NSU Car Parking Management System\\picture\\New folder\\nsu.png"));
		...
		TkPerHr.setText("10 TK per hour");
